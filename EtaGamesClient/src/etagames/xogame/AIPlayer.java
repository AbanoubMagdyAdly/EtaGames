...
public class AIPlayer extends Player {
    ...
    public final CellValue aiShape;
        ...
        Platform.runLater(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    Logger.getLogger(AIPlayer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
                }
    ...
    public int getMove(CellValue[] cells, int scale) {
        ...
        for (move = 0; move < scale; move++) {
            if (temp_cells[move] == CellValue.none) {
    ...
    public static boolean isWinner(CellValue mark, CellValue[] temp_cells) {
        ...
        return ((temp_cells[0] == mark && temp_cells[1] == mark && temp_cells[2] == mark)
                || //Across Top
                (temp_cells[3] == mark && temp_cells[4] == mark && temp_cells[5] == mark)
                || //Across Mid
                (temp_cells[6] == mark && temp_cells[7] == mark && temp_cells[8] == mark)
                || //Across Bottom
                (temp_cells[0] == mark && temp_cells[3] == mark && temp_cells[6] == mark)
                || //Down Left
                (temp_cells[1] == mark && temp_cells[4] == mark && temp_cells[7] == mark)
                || //Down Mid
                (temp_cells[2] == mark && temp_cells[5] == mark && temp_cells[8] == mark)
                || //Down Right
                (temp_cells[0] == mark && temp_cells[4] == mark && temp_cells[8] == mark)
                || //Diag TL -> BR
